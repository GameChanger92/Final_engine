    ...
    class GeminiClient:  # type: ignore
        ...
        def generate(self, prompt: str) -> str:
            ...
            return (
                ...
                "[액션] 빛나는 검이 허공을 가르며 적을 베었다. "
                '"놈들이 돌아왔다!" 그녀가 외쳤다. '
                "[액션] 화염이 폭발하며 돌바닥이 흔들렸다. "
                '"이대로 물러설 순 없어!" 그가 말했다. '
                "긴장과 설렘이 교차하는 가운데, 주인공은 첫 선택을 한다. "
                "관중들의 숨소리조차 멎은 듯 고요한 순간, 심장이 요동쳤다. "
                "[액션] 번개처럼 몸을 던져 동료를 지켜내고, "
                '"우리의 싸움은 지금부터야!" 힘찬 외침이 울려 퍼졌다. '
                "땀방울이 바닥에 떨어지며 반짝였고, 멀리서 북소리 같은 발걸음이 다가왔다. "
                "모닥불이 활활 타오르며 그림자를 길게 드리웠다. "
                "첫 번째 시련이 눈앞에 펼쳐졌지만, 그는 결코 물러서지 않을 터. "
                "[액션] 검 끝이 빛을 머금고, 파열음과 함께 공기를 갈랐다. "
                '"끝까지 싸우자!" 동료들이 화답했고, 전장은 뜨거운 함성으로 가득 찼다.'
            )
